    ...
    return Container(
      ...
      decoration: const BoxDecoration(
        ...
        image: DecorationImage(
          ...
          fit: BoxFit.cover,
          colorFilter: ColorFilter.mode(imageMaskColor, BlendMode.darken),
        ),
      ),
      child: Column(
        children: [
              ...
              child: Row(
                ...
                children: [
                  Expanded(
                    child: Text(
                      'registerTitle'.tr,
                      textScaleFactor: getScreenWidth(context: context) < 1000
                          ? textScaleF2F(context: context) * 0.65
          ...
          SizedBox(
            height: getScreenWidth(context: context) < 1000
                ? 40 * widthScaleF2F(context: context) + 15
                : 20,
          ),
          Padding(
            padding:
            ...
            child: ConstrainedBox(
              constraints:
                  BoxConstraints(maxWidth: getSubsectionWidth(context) * 0.60),
              child: Text(
